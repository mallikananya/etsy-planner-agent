...
def test_prepare_etsy_draft_payload_uses_primary_customer_files(tmp_path):
    ...
    assert "exports/png/listing-images/01_thumbnail.png" in payload["preview_assets"]
    assert "exports/png/listing-images/03_interior_pages.png" in payload["preview_assets"]
    assert "exports/png/listing-images/07_device_compatibility.png" in payload["preview_assets"]
